    ...
    <Container maxWidth="lg">
        <Grid container spacing={1} className="d-flex justify-content-end">
          ...
          <Grid item lg={3} xs={12} sm={4}>
            ...
            <Link href="https://github.com/AggelosKwstas" target="_blank" color="inherit" className="footer-icon" sx={{color:'white'}}>
              <GitHub />
            </Link>
            <Link
            ...
            <Link href="https://www.linkedin.com/in/aggelos-kwstas-876447232/" color="inherit"
            target="_blank"
            className="footer-icon"
            sx={{color:'white'}}
            >
        ...
        <Box mt={5}>
          <Typography variant="body2" color="text.secondary" align="center" style={{fontSize:'16px'}} sx={{color:'white'}}>
            {"Copyright © "}
            <Link color="inherit"style={{textDecoration:"none",fontWeight:'bolder'}} sx={{color:'white'}} >
              Aggelos Kostas
            </Link>{" "}
